...
export default function Stats() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch('https://raw.githubusercontent.com/conda-forge/by-the-numbers/main/data/live_counts.json');
    ...
    const stats2 = [
        ...
        {
            number: stats ? `${((stats.n_prs + stats.n_issues) / 1e3).toFixed(1)}K` : '',
            content: 'Issues + PRs',
        },
    ];
    ...
    return (
        <div className={[styles.about, styles.section_padding].join(' ')}>
            <div className={styles.about_description}>
                ...
                <p>
                    <Link to="https://github.com/conda-forge">conda-forge</Link> is a GitHub organization containing repositories of conda recipes.
                </p>
            </div>
            ...
            <div className={styles.about_video_description}>
                <p>Learn more about conda-forge by reading our <Link to="/docs">docs</Link> or
                    watching the following episode of <Link to="https://www.quansight.com/open-source-directions">Open Source Directions</Link>.
                </p>
            </div>
