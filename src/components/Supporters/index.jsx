        ...
        <div className={[styles.supporters, styles.section_padding].join(' ')}>
            ...
            <div className={styles.other_supporters}>
                <div className={styles.supporters_card}>
                    <div className={styles.supporters_conda_forge}>
                        <h2><span className="gradient_text">Financial</span> Support</h2>
                    </div>
                ...
                <div className={styles.supporters_card}>
                    <div className={styles.supporters_conda_forge}>
                        <h2><span className="gradient_text">Infrastructure</span> Support</h2>
                    </div>
                    <div className={styles.card}>
                ...
                <div className={styles.supporters_card}>
                    <div className={styles.supporters_conda_forge}>
                        <h2><span className="gradient_text">Developer</span> Support</h2>
                    </div>
                    <div className={styles.card}>
